...
def update_rover(Rover, data):
      ...
      'samples found:', Rover.samples_found, 'pitch, roll, yaw:', Rover.pitch, Rover.roll, Rover.yaw)
...
#      if len(rock_world_pos) > 0:
#          print ('discovered rock positions', rock_world_pos)
#          #print ('sample positions', Rover.samples_pos)
#      else:
#          print('no rock on world map')
